#
# Module manifest for module 'PoShLog.Sinks.Http'
#
...
RootModule = 'PoShLog.Sinks.Http.psm1'
...
GUID = 'fa5bee80-4782-4e8d-bdde-9bec813d1a4d'
...
It contains sink that writes log messages using HTTP POST over the network.
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'http','post','Log','Logging','Serilog','File','filelog','logfile','error-log','console','event','serilog-sink','serilog-for-powershell','wrapper','sinks','PSEdition_Desktop','PSEdition_Core','Windows','Linux','MacOS'

        # A URL to the license for this module.
        LicenseUri = 'https://github.com/PoShLog/PoShLog.Sinks.Http/blob/master/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/PoShLog/PoShLog.Sinks.Http'
